Translation = {
    English      = {
        ...
        MessageOfSystem = {
            ...
            message2           = "You can be reborn in the nearest city",
            ...
            promptLabel2        = "Revive on place",
            prompt2            = "Revive on place",
            messageON           = "You can be respawn on the place",
            RespawnIn2          = "You can respawn on the spot in ",
        },
        SuggestChat     = {
