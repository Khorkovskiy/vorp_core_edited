...
Config = {
    ...
    RespawnTime            = 20,                                   -- Time in seconds before a player can respawn.
    RespawnTime2           = 40,                                    -- Time in seconds before a player can respawn on place.
    RespawnKey             = 0xDFF812F9,                           -- Key code for respawning (default is 'E').
    RespawnKey2            = 0xB2F377E8,
    RespawnKeyTime         = 5000,                                 -- Time in milliseconds to hold the respawn key.
    RespawnKeyTime2        = 5000,                                 -- Milliseconds it will take to press the button
    CombatLogDeath         = true,                                 -- Combat loggers respawn in a dead state instead of alive.
    UseControlsCamera      = true,                                 -- Allows dead or carried players to move the camera with WASD (resource intensive).
